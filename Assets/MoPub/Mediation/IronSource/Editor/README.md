## Overview
  * This folder contains the configuration files required to integrate with the IronSource SDK.
  * To install or upgrade the IronSource SDK, please use the [SDK Manager](https://developers.mopub.com/docs/unity/getting-started/#sdkmanager) in the [MoPub Menu](https://developers.mopub.com/docs/unity/menu/) within Unity.
